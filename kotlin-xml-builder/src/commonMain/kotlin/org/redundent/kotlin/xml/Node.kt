...
open class Node(val nodeName: String) : Element {
	...
	private val _globalLevelProcessingInstructions = mutableListOf<ProcessingInstructionElement>()
	...
	private val _children = mutableListOf<Element>()
	private val childOrderMap: Map<String, Int>? by lazy {
		if (!isReflectionAvailable) {
			return@lazy null
		}

		val xmlTypeAnnotation = findXmlType(this::class) ?: return@lazy null
